...
1. [理解底层：为什么 Prompt 的结构和位置影响输出](#1-理解底层为什么-prompt-的结构和位置影响输出)
2. [黄金结构：Prompt 的推荐摆放顺序](#2-黄金结构prompt-的推荐摆放顺序)
3. [基础技法：写好每一个 Prompt 的核心原则](#3-基础技法写好每一个-prompt-的核心原则)
4. [进阶技法：撬动 LLM 推理能力的提示策略](#4-进阶技法撬动-llm-推理能力的提示策略)
5. [格式控制：让输出稳定、可解析、可复用](#5-格式控制让输出稳定可解析可复用)
6. [角色与人格：用 Persona 锚定输出风格](#6-角色与人格用-persona-锚定输出风格)
7. [长上下文处理：应对 Lost in the Middle 问题](#7-长上下文处理应对-lost-in-the-middle-问题)
8. [反模式清单：这些错误会悄悄降低输出质量](#8-反模式清单这些错误会悄悄降低输出质量)
9. [场景化模板库：开箱即用的 Prompt 框架](#9-场景化模板库开箱即用的-prompt-框架)
10. [迭代调优：像工程师一样打磨 Prompt](#10-迭代调优像工程师一样打磨-prompt)
...
*参考来源：Anthropic Prompt Engineering Docs · OpenAI Prompt Engineering Guide · Liu et al. (2024) Lost in the Middle · Wei et al. (2022) Chain-of-Thought · Wang et al. (2023) Self-Consistency · Yao et al. (2023) Tree of Thoughts · arxiv:2603.10123 Lost in the Middle at Birth*
